            ...
            if (!window.zappyContactFormLoaded) {
                try {
                    ...
                    const response = await fetch('http://localhost:5001/api/email/contact-form', {
                        ...
                        body: JSON.stringify({
                            websiteId: '219d65e4-493a-4ba6-92f6-03a26dbe265f',
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Bella Cucina uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
